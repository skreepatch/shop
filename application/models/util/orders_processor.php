...
class Orders_processor extends CI_Model{
	...
	$_tableResult['searches'] = 0;
        ...
        $tr = new Order();
        if (isset($post['orderby']) && isset($post['order']) && $post['orderby'] != 'total') {
            try {
	...
	if(isset($_POST['fromdate']) && isset($_POST['todate'])){
            $tr->where(array(
                    'created >=' => $_POST['fromdate'],
                    'created <=' => $_POST['todate']
                ));
	    $_tableResult['fromdate'] = $_POST['fromdate'];
	    $_tableResult['todate'] = $_POST['todate'];
        } 
